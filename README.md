...
- **Long video workbench** — sibling **[Danmo Film](https://github.com/danmo-ai/danmo-film)** (`:7803` / `:5803`). Make exposes only clip image/video generation APIs; Film orchestrates + assembles.
